...
iptables -t nat -A POSTROUTING -o eth1 -p tcp --dport 5000 -s 127.0.0.0/16 -d 10.0.1.4 -j SNAT --to-source 10.0.1.2
...
iptables -t nat -A POSTROUTING -o eth1 -p tcp --dport 22 -s 127.0.0.0/16 -d 10.0.1.3 -j SNAT --to-source 10.0.1.2
